...
function loadVals() {
    ...
    const simpTradOrder = localStorage['simpTradOrder'] || 'classic';
    document.querySelector(`input[name="simpTradOrder"][value="${simpTradOrder}"]`).checked = true;
...
window.addEventListener('load', () => {
    ...
    document.querySelectorAll('input[name="simpTradOrder"]').forEach((input) => {
        input.addEventListener('change',
            () => setOption('simpTradOrder', input.getAttribute('value')));
    });
